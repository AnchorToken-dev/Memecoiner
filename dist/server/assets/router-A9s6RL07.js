...
/** Prefix public files with Vite's base (needed on GitHub Pages). */
function asset(path) {
	return `/Memecoiner/${path.replace(/^\//, "")}`;
}
//#endregion
//#region src/styles.css?url
var styles_default = "/Memecoiner/assets/styles-D61WFwMP.css";
//#endregion
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Mark — memecoin developer on Solana and WETH. Zero allocation. Same market, same price. Open wallets."
			},
			{
				name: "theme-color",
				content: "#0b0c0b"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500&family=Oswald:wght@400;500;600&family=Source+Sans+3:ital,wght@0,400;0,500;0,600;1,400&display=swap"
			}
		]
	}),
...
var $$splitComponentImporter = () => import("./routes-a6ldhGxT.js");
//#endregion
...
//#endregion
export { getRouter, asset as n, router_exports as t };
