...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Cc5NWK2y.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-A9s6RL07.js").then((n) => n.t),
...
var ROUTER_BASEPATH = "Memecoiner";
var SERVER_FN_BASE = "/Memecoiner/_serverFn/";
